...
export const ROLE_PERMISSIONS: Record<AppRole, {
  ...
  admin: {
    ...
    allowedRoutes: ['/', '/inventory', '/catalog', '/sales', '/expenses', '/events', '/kitchen', '/bartender', '/staff', '/internal-consumption', '/my-orders', '/my-history', '/cash-register', '/staff-history', '/cashier-collect', '/purchase-history', '/admin-assistant', '/ticket-create', '/ticket-verify', '/ticket-admin', '/menu-generator'],
    defaultRoute: '/',
    menuItems: ['dashboard', 'inventory', 'catalog', 'sales', 'expenses', 'events', 'kitchen', 'bartender', 'staff', 'internal-consumption', 'my-orders', 'my-history', 'cash-register', 'staff-history', 'cashier-collect', 'purchase-history', 'admin-assistant', 'ticket-create', 'ticket-verify', 'ticket-admin', 'menu-generator']
  },
  mozo: {
    label: 'Mozo',
